package demo.luojun.com.demo.activity.model.socket;
...
public class ScanDeviceTool {
    ...
    private static final String TAG ="info"/* ScanDeviceTool.class.getSimpleName()*/;
    ...
    public List<String> scan() {
        ...
        Log.e(TAG, "开始扫描设备,本机Ip为：" + mDevAddress+"--"+mLocAddress);
