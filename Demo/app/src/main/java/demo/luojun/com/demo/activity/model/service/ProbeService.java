...
public class ProbeService /*extends Service implements ProbeState*/ {
...
//        return this.wifiHelper.getActiveApName();
//    }
//
//    private boolean isFrameDataSizeFitScanConversionParams(int paramInt1, int paramInt2, int paramInt3) {
...
//    }
//
//    public int getClampedGain(int paramInt) {
//        return this.probeState.getClampedGain(paramInt);
//    }
//
//    public float getCurrentFocusDepthMM() {
//        return this.probeState.getCurrentFocusDepthMM();
//    }
//
//    public float getCurrentScanDepthMM() {
//        return this.probeState.getCurrentScanDepthMM();
//    }
//
//    public int getGain() {
//        return this.probeState.getGain();
//    }
//
//    public int getMaxGainValue() {
//        return this.probeState.getMaxGainValue();
//    }
//
//    public ProbeScanType getProbeScanType() {
//        return this.probeState.getProbeScanType();
//    }
//
//    public ProbeState.PtBfMode getPtBfMode() {
//        return this.probeState.getPtBfMode();
//    }
//
...
//    }
//
//    public void loadArrayScanCmdCtrlParamsFromConfigFile() {
//        this.probeState.loadArrayScanCmdCtrlParamsFromConfigFile();
//    }
//
//    public void loadDefaultTableParams() {
//        this.probeState.loadDefaultTableParams();
//    }
//
//    public ArrayScanCmdCtrlParams makeArrayScanCmdCtrlParams() {
//        return this.probeState.makeArrayScanCmdCtrlParams();
//    }
//
//    public ScanConversionParams makeScanConversionParams() {
//        return this.probeState.makeScanConversionParams();
//    }
//
...
////    }
//    }
////    public void setArrayScanCmdCtrlParams(ArrayScanCmdCtrlParams paramArrayScanCmdCtrlParams) {
////        this.probeState.setArrayScanCmdCtrlParams(paramArrayScanCmdCtrlParams);
////    }
//
//    public void setMaxGainValue(int paramInt) {
//        this.probeState.setMaxGainValue(paramInt);
//    }
//
//    public void setProbeStateListener(ProbeStateListener paramProbeStateListener) {
//        this.probeStateListener = paramProbeStateListener;
//    }
//
//    public void setProbeWifi(String paramString1, String paramString2) {
//    }
//
//    public void setScanConversionImageSize(int paramInt1, int paramInt2) {
//        this.probeState.updateOutputImageSize(paramInt1, paramInt2);
//    }
//
...
//    }
//
//    public void updateOutputImageSize(int paramInt1, int paramInt2) {
//        this.probeState.updateOutputImageSize(paramInt1, paramInt2);
//    }
//
...
//
//        public PacketHandler(Looper param1Looper) {
//            super(param1Looper);
//        }
//
...
//                            try {
//                                while (!packet.writePacket(ProbeSocketThread.this.outputStream)) {
...
//                                        Message message = ProbeSocketThread.this.this$0.packetHandler.obtainMessage();
//                                        message.obj = sendProgressPacket;
//                                        ProbeSocketThread.this.this$0.packetHandler.sendMessage(message);
//                                    }
//                                    Thread.sleep(100L);
//                                }
//                            } catch (IOException iOException) {
...
/* Location:              D:\androidWord\apkedit\dex2jar-2.0\classes-dex2jar.jar!\com\lee\arrayscan2\service\ProbeService.class
